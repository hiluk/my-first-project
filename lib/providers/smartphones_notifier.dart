...
part 'smartphones_notifier.g.dart';

@riverpod
class SmartphonesNotifier extends _$SmartphonesNotifier {
  ...
  @override
  FutureOr<List<SmartphoneModel>> build() async {
    await Future.delayed(const Duration(seconds: 2));
    return smartphones;
  }

  List<SmartphoneModel> filterSmartphones(String smartphoneName) {
    List<SmartphoneModel> result = [];
    if (smartphoneName.isEmpty) {
      result = smartphones;
    } else {}
